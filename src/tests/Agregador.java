...
//    }
    ...
    for (int i = 0; i < conId.size(); i++) {
      ...
      clases += "\n\n"
          + "  @Test\r\n" +
          "  public void testSet" + BasicMethods.toMayusq(conId.get(i)) + "() {\r\n" +
    ...
    if(!sets.isEmpty()) {
      ...
      Sets+="\r\n" + 
          ...
          "    Field field = "+clase+".class.getDeclaredField(nameOfVariable);\r\n" + 
    ...
    for (int i = 0; i < sets.size(); i++) {
      ...
      Sets += "\n\n"+
          "    @Test\r\n" +
          "    public void test" + auxSet + "() throws Exception {\r\n" +
          "      Set<" + setsType.get(i) + "> mockedSet = mock(Set.class);\r\n" +
          "      when(mockedSet.size()).thenReturn(TEST_INTEGER);\r\n" +
          "      setList(mockedSet, \""+sets.get(i)+"\");\n" +
          "      assertThat(underTest.get" + auxSet + "().size()).isEqualTo(TEST_INTEGER);\r\n" +
          "    }\r\n" +
          "   \r\n" +
          "    @Test\r\n" +
          "    public void test" + auxSet + "Empty() throws Exception  {\r\n" +
          "      setList(Collections.emptySet(), \""+sets.get(i)+"\");\n" +
          "      assertThat(underTest.get" + auxSet + "()).isNotNull().isEmpty();\r\n" +
          "    }\r\n" +
          "   \r\n" +
          "    @Test\r\n" +
          "    public void test" + auxSet + "NotNull() throws Exception  {\r\n" +
          "      setList(null, \""+sets.get(i)+"\");\n" +
          "      assertThat(underTest.get" + auxSet + "()).isNotNull().isEmpty();\r\n" +
          "    }\r\n" +
          "   \r\n" +
          "";
...
//        Escribir2.escribir(url, r, clase);break;
  ...
  public static String oldEquals(String clase) {
    String equals = 
        "  @Test\r\n" + 
        "  public final void testEquals() {\r\n" + 
        "  "+clase+" compareEquals = new "+clase+"();\n" + 
        "    compareEquals.setId(new "+clase+"Id(TEST_INTEGER));\r\n" + 
  ...
  public static String Simplevars(String url, String clase, ArrayList<String> vars,
    ...
    for (int i = 0; i < varsTypes.size(); i++) {
      ...
      if (type.equalsIgnoreCase("Boolean")) {
        ...
        r += "  @Test\r\n" +
            "  public void testSet" + var + "() throws Exception {\r\n" +
  ...
  public static String toString(String clase, ArrayList<String> vars,
      ArrayList<String> varsTypes,ArrayList<String> conId) {
...
//        + "    FieldSetter.setField(underTest, " + clase + ".class.getDeclaredField(\"id\"), TEST_INTEGER);\n";
    for (int i = 0; i < vars.size(); i++) {
      ...
      case "Boolean": r+="(true);\n";
        break;
      case "String":r+="(\"test" + name + "\");\n";
        break;
      case "Integer": r+="(TEST_INTEGER);\n";
        break;
      case "Float": r+="(TEST_FLOAT);\n";
      break;
      case "LocalDateTime":r+="(TEST_LOCALDATETIME);\n";
        break;
      case "LocalDate":r+="(TEST_LOCALDATE);\n";
      break;
      }
    ...
    for (int i = 0; i < conId.size(); i++) {
      String mayusq = BasicMethods.toMayusq(conId.get(i));
      r += "    assertThat(underTest.toString()).contains(\""+ conId.get(i) + "="+mayusq+"[id=\"+TEST_INTEGER+\"]\");\n";
